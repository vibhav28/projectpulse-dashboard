...
import { BarChart3, MessageSquare, FileText, ArrowRight, Zap } from "lucide-react";
...
const features = [
  {
    ...
    description: "AI-powered insights from your project data. Spot bottlenecks, track velocity, and predict delivery dates.",
  },
  {
    icon: MessageSquare,
    title: "RAG Chatbot",
    description: "Chat with your project data using retrieval-augmented generation. Get instant, sourced answers.",
  },
  {
    icon: FileText,
    title: "Automated Reports",
    description: "Generate comprehensive project reports automatically. Export and share with stakeholders.",
  },
];
    ...
    <div className="min-h-screen gradient-hero">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold tracking-tight text-foreground">ProjectPulse</span>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10 leading-relaxed">
            Upload your project data or connect Jira, then chat with AI to get instant analytics, insights, and sourced answers.
          </p>
